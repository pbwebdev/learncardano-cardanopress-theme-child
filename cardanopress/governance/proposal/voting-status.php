    ...
    <?php foreach ($proposal->getOptions() as $option) : ?>
        <div>
            <p>
                ...
                <span x-show="hasVoted('<?php echo esc_js($option['value']); ?>')"> 
                <img alt="CardanoPress Wapuu" src="https://learncardano.io/wp-content/uploads/2023/10/cardanopress-wapuu-icon.png" width="30" height="30">
                 </span>
            </p>
            <p>
